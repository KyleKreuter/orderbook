...
public class OrderbookOrderByQuantityTest {

    @Test
    public void order_by_quantity_on_equal_value() {
        ...
        Assertions.assertEquals(secondClient.getId(), firstOrder.client().getId());
